...
public interface AtomicPackage extends EPackage
{
	 ...
	 * @generated
	 */
	String eNS_URI = "http://vitruv.tools/metamodels/change/atomic/1.0";
	 ...
	 * @see tools.vitruv.change.atomic.impl.AtomicPackageImpl#getId()
	 * @generated
	 */
	int ID = 3;
	...
	/**
	 * Returns the meta object for the '{@link tools.vitruv.change.atomic.EChange#isResolved() <em>Is Resolved</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Is Resolved</em>' operation.
	 * @see tools.vitruv.change.atomic.EChange#isResolved()
	 * @generated
	 */

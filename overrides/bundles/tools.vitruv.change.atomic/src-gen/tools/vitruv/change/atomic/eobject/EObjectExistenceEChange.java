 ...
 * </p>
 * <ul>
 *   <li>{@link tools.vitruv.change.atomic.eobject.EObjectExistenceEChange#getAffectedEObject <em>Affected EObject</em>}</li>
 *   <li>{@link tools.vitruv.change.atomic.eobject.EObjectExistenceEChange#getIdAttributeValue <em>Id Attribute Value</em>}</li>
 *   <li>{@link tools.vitruv.change.atomic.eobject.EObjectExistenceEChange#getAffectedEObjectID <em>Affected EObject ID</em>}</li>
...
public interface EObjectExistenceEChange<A extends EObject> extends EChange
{
	 ...
	 * @see tools.vitruv.change.atomic.eobject.EobjectPackage#getEObjectExistenceEChange_AffectedEObject()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link tools.vitruv.change.atomic.eobject.EObjectExistenceEChange#getAffectedEObject <em>Affected EObject</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see tools.vitruv.change.atomic.eobject.EobjectPackage#getEObjectExistenceEChange_AffectedEObjectID()
	...
	/**
	 * Sets the value of the '{@link tools.vitruv.change.atomic.eobject.EObjectExistenceEChange#getAffectedEObjectID <em>Affected EObject ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

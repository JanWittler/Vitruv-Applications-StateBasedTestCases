...
public interface EobjectPackage extends EPackage
{
	 ...
	 * @generated
	 */
	String eNS_URI = "http://vitruv.tools/metamodels/change/atomic/eobject/1.0";
	 ...
	 * @ordered
	 */
	int EOBJECT_ADDED_ECHANGE__NEW_VALUE_ID = AtomicPackage.ADDITIVE_ECHANGE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int EOBJECT_ADDED_ECHANGE_FEATURE_COUNT = AtomicPackage.ADDITIVE_ECHANGE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int EOBJECT_ADDED_ECHANGE___IS_RESOLVED = AtomicPackage.ADDITIVE_ECHANGE___IS_RESOLVED;
	 ...
	 * @ordered
	 */
	int EOBJECT_SUBTRACTED_ECHANGE__OLD_VALUE_ID = AtomicPackage.SUBTRACTIVE_ECHANGE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int EOBJECT_SUBTRACTED_ECHANGE_FEATURE_COUNT = AtomicPackage.SUBTRACTIVE_ECHANGE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int EOBJECT_SUBTRACTED_ECHANGE___IS_RESOLVED = AtomicPackage.SUBTRACTIVE_ECHANGE___IS_RESOLVED;
	 ...
	 * @ordered
	 */
	int EOBJECT_EXISTENCE_ECHANGE__AFFECTED_EOBJECT = AtomicPackage.ECHANGE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int EOBJECT_EXISTENCE_ECHANGE__AFFECTED_EOBJECT_ID = AtomicPackage.ECHANGE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int EOBJECT_EXISTENCE_ECHANGE__AFFECTED_EOBJECT_TYPE = AtomicPackage.ECHANGE_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int EOBJECT_EXISTENCE_ECHANGE_FEATURE_COUNT = AtomicPackage.ECHANGE_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int EOBJECT_EXISTENCE_ECHANGE___IS_RESOLVED = AtomicPackage.ECHANGE___IS_RESOLVED;
	...
	/**
	 * Returns the meta object for the attribute '{@link tools.vitruv.change.atomic.eobject.EObjectAddedEChange#getNewValueID <em>New Value ID</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>New Value ID</em>'.
	 * @see tools.vitruv.change.atomic.eobject.EObjectAddedEChange#getNewValueID()
	 * @see #getEObjectAddedEChange()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link tools.vitruv.change.atomic.eobject.EObjectSubtractedEChange#getOldValueID <em>Old Value ID</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Old Value ID</em>'.
	 * @see tools.vitruv.change.atomic.eobject.EObjectSubtractedEChange#getOldValueID()
	 * @see #getEObjectSubtractedEChange()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link tools.vitruv.change.atomic.eobject.EObjectExistenceEChange#getAffectedEObject <em>Affected EObject</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Affected EObject</em>'.
	 * @see tools.vitruv.change.atomic.eobject.EObjectExistenceEChange#getAffectedEObject()
	...
	/**
	 * Returns the meta object for the attribute '{@link tools.vitruv.change.atomic.eobject.EObjectExistenceEChange#getAffectedEObjectID <em>Affected EObject ID</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Affected EObject ID</em>'.
	 * @see tools.vitruv.change.atomic.eobject.EObjectExistenceEChange#getAffectedEObjectID()
	 * @see #getEObjectExistenceEChange()
	 * @generated
	 */
